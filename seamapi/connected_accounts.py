...
class ConnectedAccounts(AbstractConnectedAccounts):
  ...
  def list(self, custom_metadata_has: Optional[Dict[str, Any]] = None) -> List[ConnectedAccount]:
    json_payload = {}
  ...
  def update(self, connected_account_id: str, automatically_manage_new_devices: Optional[bool] = None, custom_metadata: Optional[Dict[str, Any]] = None) -> ConnectedAccount:
    json_payload = {}
