...
class UsersAcs(AbstractUsersAcs):
    ...
    def delete(self, acs_user_id: Optional[Any] = None):
        ...
        res = self.seam.make_request("POST", "/acs/users/delete", json=json_payload)
        return None.from_dict(res[""])
    ...
    def suspend(self, acs_user_id: Optional[Any] = None):
        ...
        if acs_user_id is not None:
            json_payload["acs_user_id"] = acs_user_id
        res = self.seam.make_request("POST", "/acs/users/suspend", json=json_payload)
        return None.from_dict(res[""])
    ...
    def unsuspend(self, acs_user_id: Optional[Any] = None):
        ...
        if acs_user_id is not None:
            json_payload["acs_user_id"] = acs_user_id
        res = self.seam.make_request("POST", "/acs/users/unsuspend", json=json_payload)
        return None.from_dict(res[""])
    ...
    def update(
        ...
        res = self.seam.make_request("POST", "/acs/users/update", json=json_payload)
        return None.from_dict(res[""])
