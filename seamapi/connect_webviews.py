...
class ConnectWebviews(AbstractConnectWebviews):
  ...
  def list(self, user_identifier_key: Optional[str] = None, custom_metadata_has: Optional[Dict[str, Any]] = None) -> List[ConnectWebview]:
    json_payload = {}
