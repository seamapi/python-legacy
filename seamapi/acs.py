...
from seamapi.acs_credential_provisioning_automations import AcsCredentialProvisioningAutomations
...
class Acs(AbstractAcs):
  ...
  def __init__(self, seam: Seam):
    ...
    self._credential_provisioning_automations = AcsCredentialProvisioningAutomations(seam=seam)
  ...
  @property
  def credential_provisioning_automations(self) -> AcsCredentialProvisioningAutomations:
