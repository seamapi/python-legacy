from seamapi.types import (AbstractThermostatsClimateSettingSchedules,AbstractSeam as Seam,ClimateSettingSchedule)
...
class ThermostatsClimateSettingSchedules(AbstractThermostatsClimateSettingSchedules):
  ...
  def get(self, climate_setting_schedule_id: Optional[str] = None, device_id: Optional[str] = None) -> ClimateSettingSchedule:
    json_payload = {}
  ...
  def list(self, device_id: str, user_identifier_key: Optional[str] = None) -> List[ClimateSettingSchedule]:
    json_payload = {}
