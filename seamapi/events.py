...
class Events(AbstractEvents):
  ...
  def get(self, event_id: Optional[str] = None, event_type: Optional[str] = None, device_id: Optional[str] = None) -> Event:
    json_payload = {}
  ...
  def list(self, since: Optional[str] = None, between: Optional[List[Any]] = None, device_id: Optional[str] = None, device_ids: Optional[List[str]] = None, access_code_id: Optional[str] = None, access_code_ids: Optional[List[str]] = None, event_type: Optional[str] = None, event_types: Optional[List[str]] = None, connected_account_id: Optional[str] = None, limit: Optional[float] = None) -> List[Event]:
    json_payload = {}
