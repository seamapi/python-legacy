...
class AcsEntrances(AbstractAcsEntrances):
  ...
  def list(self, acs_system_id: Optional[str] = None, acs_credential_id: Optional[str] = None) -> None:
    json_payload = {}
  ...
  def list_credentials_with_access(self, acs_entrance_id: str, include_if: Optional[List[str]] = None) -> None:
    json_payload = {}
