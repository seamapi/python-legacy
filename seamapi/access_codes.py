...
class AccessCodes(AbstractAccessCodes):
  ...
  def delete(self, access_code_id: str, device_id: Optional[str] = None, sync: Optional[bool] = None) -> None:
    json_payload = {}
  ...
  def get(self, device_id: Optional[str] = None, access_code_id: Optional[str] = None, code: Optional[str] = None) -> AccessCode:
    json_payload = {}
  ...
  def list(self, device_id: Optional[str] = None, access_code_ids: Optional[List[str]] = None, user_identifier_key: Optional[str] = None) -> List[AccessCode]:
    json_payload = {}
  ...
  def update(self, access_code_id: str, name: Optional[str] = None, starts_at: Optional[str] = None, ends_at: Optional[str] = None, code: Optional[str] = None, sync: Optional[bool] = None, attempt_for_offline_device: Optional[bool] = None, prefer_native_scheduling: Optional[bool] = None, use_backup_access_code_pool: Optional[bool] = None, allow_external_modification: Optional[bool] = None, is_external_modification_allowed: Optional[bool] = None, use_offline_access_code: Optional[bool] = None, is_offline_access_code: Optional[bool] = None, is_one_time_use: Optional[bool] = None, max_time_rounding: Optional[str] = None, device_id: Optional[str] = None, type: Optional[str] = None, is_managed: Optional[bool] = None) -> None:
    json_payload = {}
