...
class AcsCredentials(AbstractAcsCredentials):
  ...
  def create(self, acs_user_id: str, access_method: str, code: Optional[str] = None, is_multi_phone_sync_credential: Optional[bool] = None, visionline_metadata: Optional[Dict[str, Any]] = None, starts_at: Optional[str] = None, ends_at: Optional[str] = None) -> None:
    json_payload = {}
    ...
    if is_multi_phone_sync_credential is not None:
      json_payload["is_multi_phone_sync_credential"] = is_multi_phone_sync_credential
  ...
  def list(self, acs_user_id: Optional[str] = None, acs_system_id: Optional[str] = None, user_identity_id: Optional[str] = None, is_multi_phone_sync_credential: Optional[bool] = None) -> None:
    json_payload = {}
