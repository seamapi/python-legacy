...
class AcsCredentials(AbstractAcsCredentials):
  ...
  def create(self, acs_user_id: str, access_method: str, code: Optional[str] = None, is_multi_phone_sync_credential: Optional[bool] = None, external_type: Optional[str] = None, visionline_metadata: Optional[Dict[str, Any]] = None, starts_at: Optional[str] = None, ends_at: Optional[str] = None) -> None:
    json_payload = {}
