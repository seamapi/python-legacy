...
from seamapi.user_identities_enrollment_automations import UserIdentitiesEnrollmentAutomations
...
class UserIdentities(AbstractUserIdentities):
  ...
  def create(self, user_identity_key: Optional[str] = None, email_address: Optional[str] = None, phone_number: Optional[str] = None, full_name: Optional[str] = None) -> None:
    json_payload = {}
  ...
  def get(self, user_identity_id: Optional[str] = None, user_identity_key: Optional[str] = None) -> None:
    json_payload = {}
  ...
  def update(self, user_identity_id: str, user_identity_key: Optional[str] = None, email_address: Optional[str] = None, phone_number: Optional[str] = None, full_name: Optional[str] = None) -> None:
    json_payload = {}
