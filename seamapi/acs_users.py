...
class AcsUsers(AbstractAcsUsers):
  ...
  def create(self, acs_system_id: str, acs_access_group_ids: Optional[List[str]] = None, user_identity_id: Optional[str] = None, access_schedule: Optional[Dict[str, Any]] = None, full_name: Optional[str] = None, email: Optional[str] = None, phone_number: Optional[str] = None, email_address: Optional[str] = None) -> None:
    json_payload = {}
  ...
  def list(self, user_identity_id: Optional[str] = None, user_identity_phone_number: Optional[str] = None, user_identity_email_address: Optional[str] = None, acs_system_id: Optional[str] = None) -> None:
    json_payload = {}
  ...
  def remove_from_access_group(self, acs_user_id: str, acs_access_group_id: str) -> None:
    json_payload = {}
  ...
  def update(self, acs_user_id: str, access_schedule: Optional[Dict[str, Any]] = None, full_name: Optional[str] = None, email: Optional[str] = None, phone_number: Optional[str] = None, email_address: Optional[str] = None, hid_acs_system_id: Optional[str] = None) -> None:
    json_payload = {}
