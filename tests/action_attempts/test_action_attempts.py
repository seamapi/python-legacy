...
def test_action_attempts(seam: Seam):
    ...
    retrieved_action_attempt = seam.action_attempts.get(action_attempt_id=unlock_door.action_attempt_id)
    ...
    action_attempts = seam.action_attempts.list(action_attempt_ids=[unlock_door1.action_attempt_id, unlock_door2.action_attempt_id])
    ...
    action_attempt = seam.action_attempts.poll_until_ready(action_attempt_id=unlock_door.action_attempt_id)
